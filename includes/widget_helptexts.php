...
$widget_items_helptexts = array(
	...
	'url_to_page' =>          array('type'          => 'text',
	                                'caption'       => __('URL to the linked atozsites Event page','event-list').':',
	                                'caption_after' => null,
	                                'tooltip'       => __('This option defines the url to the linked atozsites Event page. This option is required if you want to use one of the options below.','event-list'),
	...
	'sc_id_for_url' =>        array('type'          => 'text',
	                                ...
	                                'caption_after' => null,
	                                'tooltip'       => __('This option defines the shortcode-id for the atozsites Event on the linked page. Normally the standard value 1 is correct, you only have to change it if you use multiple event-list shortcodes on the linked page.','event-list'),
	                                'form_style'    => null,
	                                'form_width'    => 35),
	...
	'link_to_page' =>         array('type'          => 'checkbox',
	                                'caption'       => __('Add a link to the atozsites Event page','event-list'),
	                                'caption_after' => null,
	...
	'link_to_page_caption' => array('type'          => 'text',
	                                ...
	                                'caption_after' => null,
	                                'tooltip'       => __('This option defines the text for the link to the atozsites Event page if the approriate option is selected.','event-list'),
