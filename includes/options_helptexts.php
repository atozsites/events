...
$options_helptexts = array(
	...
	'el_head_feed_link'       => array('type'    => 'checkbox',
	                                   ...
	                                   'desc'    => __('This option adds a RSS feed in the html head for the events.','event-list').'<br />
	                                                ...
	                                                '.sprintf(__('The second way is to include a visible feed link directly in the atozsites Event. This can be done by setting the shortcode attribute %1$s to %2$s.','event-list'), '<code>add_feed_link</code>', '"true"').'<br />
	...
	'el_feed_link_pos'        => array('type'    => 'radio',
	                                   ...
	                                   'desc'    => __('This option specifies the position of the RSS feed link in the atozsites Event.','event-list').'<br />
	...
	'el_feed_link_align'      => array('type'    => 'radio',
	                                   ...
	                                   'desc'    => __('This option specifies the align of the RSS feed link in the atozsites Event.','event-list').'<br />
	                                                '.sprintf(__('You have to set the shortcode attribute %1$s to %2$s if you want to show the feed link.','event-list'), '<code>add_feed_link</code>', '"true"')),

	'el_feed_link_text'       => array('type'    => 'text',
	                                   'label'   => __('Feed link text','event-list'),
	                                   'desc'    => __('This option specifies the caption of the RSS feed link in the atozsites Event.','event-list').'<br />
