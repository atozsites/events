...
$sc_eventlist_helptexts = array(
	...
	'date_filter'      => array('val'    => array('all', 'upcoming', 'past', strtoupper(__('year','event-list'))),
	                            'desc'   => sprintf(__('This attribute defines the dates and date ranges of which events are displayed. The default is %1$s to show all events.','event-list'), '"all"').'<br />'.
	                                        sprintf(__('Filtered events according to %1$s value are not available in the atozsites Event.','event-list'), 'date_filter').'<br />'.
	...
	'cat_filter'       => array('val'    => array('all', strtoupper(__('category slugs','event-list'))),
	                            'desc'   => sprintf(__('This attribute defines the category filter which filters the events to show. The default is $1$s or an empty string to show all events.','event-list'), '"all"').'<br />'.
	                                        sprintf(__('Events with categories that doesn´t match %1$s are not shown in the atozsites Event. They are also not available if a manual url parameter is added.','event-list'), 'cat_filter').'<br />'.
	...
	'num_events'       => array('val'    => array(strtoupper(__('number','event-list'))),
	                            'desc'   => sprintf(__('This attribute defines how many events should be displayed if upcoming events is selected. With the default value %1$s all events will be displayed.','event-list'), '"0"').'<br />'.
	                                        __('Please not that in the actual version there is no pagination of the events available, so the atozsites Event can be very long.','event-list')),
	...
	'show_filterbar'   => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute defines if the filterbar should be displayed. The filterbar allows the users to specify filters for the listed events.','event-list').'<br />'.
	                                        ...
	                                        sprintf(__('With %1$s the filterbar is only visible in the atozsites Event and with %2$s only in the single event view.','event-list'), '"event_list_only"', '"single_event_only"')),
	...
	'title_length'     => array('val'    => array(__('number','event-list'), 'auto'),
	                            'desc'   => __('This attribute specifies if the title should be truncated to the given number of characters in the atozsites Event.','event-list').'<br />'.
	...
	'show_starttime'   => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if the starttime is displayed in the atozsites Event.<br />
	                                            Choose "false" to always hide and "true" to always show the starttime.<br />
	                                            With "event_list_only" the starttime is only visible in the atozsites Event and with "single_event_only" only for a single event','event-list')),

	'show_location'    => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if the location is displayed in the atozsites Event.<br />
	                                            Choose "false" to always hide and "true" to always show the location.<br />
	                                            With "event_list_only" the location is only visible in the atozsites Event and with "single_event_only" only for a single event','event-list')),
	...
	'show_cat'         => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if the categories are displayed in the atozsites Event.<br />
	                                            Choose "false" to always hide and "true" to always show the category.<br />
	                                            With "event_list_only" the categories are only visible in the atozsites Event and with "single_event_only" only for a single event','event-list')),

	'show_content'     => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if the content is displayed in the atozsites Event.<br />
	                                            Choose "false" to always hide and "true" to always show the content.<br />
	                                            With "event_list_only" the content is only visible in the atozsites Event and with "single_event_only" only for a single event','event-list')),

	'content_length'   => array('val'    => array(__('number','event-list')),
	                            'desc'   => __('This attribute specifies if the content should be truncate to the given number of characters in the atozsites Event.','event-list').'<br />'.
	...
	'collapse_content' => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if the content should be collapsed initially.<br />
	                                            ...
	                                            With "event_list_only" the content is only collapsed in the atozsites Event view and with "single_event_only" only in single event view.','event-list')),

	'link_to_event'    => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only', 'events_with_content_only'),
	                            'desc'   => __('This attribute specifies if a link to the single event should be added onto the event name in the atozsites Event.<br />
	                                            Choose "false" to never add and "true" to always add the link.<br />
	                                            With "event_list_only" the link is only added in the atozsites Event and with "single_event_only" only for a single event.<br />
	                                            With "events_with_content_only" the link is only added in the atozsites Event for events with event content.','event-list')),
	...
	'add_feed_link'    => array('val'    => array('false', 'true', 'event_list_only', 'single_event_only'),
	                            'desc'   => __('This attribute specifies if a rss feed link should be added.<br />
	                                            ...
	                                            Choose "false" to never add and "true" to always add the link.<br />
	                                            With "event_list_only" the link is only added in the atozsites Event and with "single_event_only" only for a single event','event-list')),
