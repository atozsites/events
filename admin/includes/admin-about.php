...
class EL_Admin_About {
	...
	public function show_about() {
		...
		echo '<div class="wrap">
				<div id="icon-edit-pages" class="icon32"><br /></div><h2>'.__('About atozsites Event','event-list').'</h2>';
	...
	private function show_help() {
		echo '
			...
			<li>'.sprintf(__('you can add the <strong>widget</strong> %1$s in your sidebars','event-list'), '"atozsites Event"').'</li></ul>
			<p>'.__('The displayed events and their style can be modified with the available widget settings and the available attributes for the shortcode.','event-list').'<br />
				...
				'.sprintf(__('If you enable one of the links options (%1$s or %2$s) in the widget you have to insert an URL to the linked event-list page.','event-list'), '"'.__('Add links to the single events','event-list').'"', '"'.__('Add a link to the atozsites Event page','event-list').'"')
